...
class ValidationClass:NSObject{
    ...
    static let vcErrorAllinOne = "Password must contains at least 1 special characters, 1 number,1 UpperCase."
...
extension ValidationClass {
    ...
    class func verifyname(text : String) -> (String, Bool) {
        ...
        } else if text.count < 2 || !text.containsAlphabetsOnly() {
    ...
    class func verifyFullname(text : String) -> (String, Bool) {
        ...
        if text.count == 0 {
            verifyObj.message = vcErrorname
        } else if text.count < 2 || !text.isValidName() {
            verifyObj.message = vcErrorValidname
        } else {
            verifyObj.isVerified = true
        }
    ...
    class func verifyFirstname(text : String) -> (String, Bool) {
        var verifyObj = (message : "", isVerified : false)
        if text.count == 0 {
            verifyObj.message = vcErrorFirstname
        } else if text.count < 2 || !text.containsAlphabetsOnly() {
    ...
    class func verifyAboutMe(text : String) -> (String, Bool) {
        ...
        } else if text.count < 2 || !text.containsAlphaNumericOnly() {
...
//        }
    ...
    class func verifyLastname(text : String) -> (String, Bool) {
        var verifyObj = (message : "", isVerified : false)
        if text.count == 0 {
            verifyObj.message = vcErrorLastname
        } else if text.count < 2 || !text.containsAlphabetsOnly() {
    ...
    class func verifyEmailOrUsername(text : String) -> (String, Bool) {
        ...
        } else if !text.contains("@") && text.count < 2  {
            verifyObj.message = vcErrorValidUsername
...
//            verifyObj.message = vcErrorAllinOne
        ...
        }else if !text.checkTextSufficientComplexityUpperCase() {
            verifyObj.message = vcErrorValidUpperPassword
        } else if !text.checkTextSufficientComplexityNumber() {
            verifyObj.message = vcErrorValidNumberPassword
        }else {
            verifyObj.isVerified = true
        }
